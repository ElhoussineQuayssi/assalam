...
const NousSommes = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div
        className="relative isolate bg-[url('/bg-nous.jpg')] bg-fixed bg-no-repeat bg-cover bg-right text-slate-800 py-24 sm:py-32"
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-8 text-pretty text-lg font-semibold text-blue-800 sm:text-xl/8">
              Description of the foundation goes here.
            </p>
          </div>
          <div
      ...
      >
        <div className="relative z-10 flex-1 flex md:flex-col justify-evenly items-start gap-1 w-full">
      ...
      <div
        className="p-10 bg-transparent h-fit flex flex-col justify-center items-center gap-10"
      >
        <h1
        ...
        <div
          className="grid grid-rows-2 md:grid-cols-4 h-fit gap-12 items-center h-96"
        >
          {tawajohatona.map((item, index) => (
            <div key={index} className="card bg-base-100 shadow-xl hover:shadow-2xl h-96 transition-shadow duration-300">
              <figure className="">
      ...
      >
        ...
        <div
          className="w-full md:w-2/3 p-4 md:p-10 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-6 gap-4 border-8 border-blue-500 rounded-lg bg-white"
        >
